...
export const stateResilienceTestSuite = ({
  ...
  it("handles transient database errors gracefully with multiple slots", async ({
    flakyStateAdapter,
    stateAdapter,
    notifyAdapter,
    withTransaction,
  ...
  it("handles transient database errors gracefully with multiple workers", async ({
    flakyStateAdapter,
    stateAdapter,
    notifyAdapter,
    withTransaction,
  ...
  it("handles real database errors gracefully with multiple slots", async ({
    flakyDbStateAdapter,
    stateAdapter,
    notifyAdapter,
    withTransaction,
  ...
  it("handles real database errors gracefully with multiple workers", async ({
    flakyDbStateAdapter,
    stateAdapter,
    notifyAdapter,
    withTransaction,
