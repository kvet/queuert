# Postgres (Drizzle) + Redis Example

This example demonstrates how to use Queuert with:

- **PostgreSQL** (via Drizzle ORM) for state storage
- **Redis** for notifications

## What it does

1. Connects to PostgreSQL and Redis
2. Creates a Drizzle database connection and runs schema migrations
...
# Run the example
pnpm --filter @queuert/postgres-drizzle-redis start
```
