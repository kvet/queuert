...
SQLite state storage via `@queuert/sqlite` with Prisma ORM — atomic job creation inside application transactions, with `createAsyncLock()` for write serialization.
