...
- **Read [Code Style](code-style.md) before writing code**: it is the source of truth for general principles, testing patterns, documentation update guidelines, and examples naming conventions
