...
- **Consult [design docs](docs/design/) before changes**: When modifying adapters, job processing, workers, or other core systems, read the corresponding design doc first to understand architectural decisions that must be preserved
- No obvious comments
