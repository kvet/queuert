...
- **Consult [reference docs](docs/src/content/docs/reference/) before changes**: When modifying adapters, job processing, workers, or other core systems, read the corresponding reference doc first to understand architectural decisions that must be preserved
- No obvious comments
