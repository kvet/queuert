...
- **Index consolidation** — indexes reorganized from 10 to 12. Dropped: `job_acquisition_idx`, `job_expired_lease_idx`, `job_listing_status_idx`, `job_listing_type_name_idx`, `chain_listing_type_name_idx`, `chain_listing_idx`, `job_listing_idx`. Added: `job_ready_idx`, `job_pending_idx`, `job_running_idx`, `job_completed_idx`, `job_continuation_idx`, `chain_tail_running_idx`, `chain_tail_completed_idx`, `chain_head_idx`, `job_idx`. Surviving: `chain_index_idx`, `job_deduplication_idx`, `job_blocker_chain_idx`.
